    ...
    var body: some View {
        ZStack {
            ...
            Circle()
                ...
                .position(pulsePosition(in: CGSize(width: 300, height: 300)))
        ...
        .onAppear {
            withAnimation(.linear(duration: 4.5).repeatForever(autoreverses: false)) { pulseProgress = 1 }
        }
